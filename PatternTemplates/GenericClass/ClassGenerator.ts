...
class ClassGenerator {
  ...
  public static instance: ClassGenerator;

  constructor() {
    if(ClassGenerator.instance == null)
    {
      ClassGenerator.instance = this;
    }
   }

  createFileFromTemplate(diagramElement: any, diagramElements: any): string {
    const fileContent = fs.readFileSync("PatternTemplates/GenericClass/GenericClass.ts", "utf-8");
